...
import sty from "./PlasmicDeveloperFlexibilitySection.module.css"; // plasmic-import: aD1BzX0TEUk/css
...
function PlasmicDeveloperFlexibilitySection__RenderFunc(props: {
  ...
  return (
    <ValuePropsListSection
      ...
      showcaseImage={
        <div className={classNames(projectcss.all, sty.freeBox__nVmFp)}>
          <img
      ...
      slot3={
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___8ZbOi)}
        >
          <ButtonLink
          ...
          {false ? (
            ...
            >
              <ButtonLink
                icon={
                  <Icon8Icon
                    className={classNames(projectcss.all, sty.svg__aMyDm)}
                    role={"img"}
                  />
                }
    ...
    >
      <ValuePropListItem
        slot={
          ...
          >
            <Icon13Icon
              className={classNames(projectcss.all, sty.svg___0Fc0K)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropListItem
        slot={
          ...
          >
            <Icon27Icon
              className={classNames(projectcss.all, sty.svg___0BseX)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropListItem
        slot={
          ...
          >
            <Icon25Icon
              className={classNames(projectcss.all, sty.svg__vlVjI)}
              role={"img"}
            />
          </GraphicIcon>
        }
