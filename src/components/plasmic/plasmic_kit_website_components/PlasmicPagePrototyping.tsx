...
import sty from "./PlasmicPagePrototyping.module.css"; // plasmic-import: WzZa1_nedVe/css
    ...
    >
      ...
      <PageHero
        ...
        slot2={
          ...
          >
            <Icon14Icon
              className={classNames(projectcss.all, sty.svg___6CUez)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__eVbcR)}
            src={image6Zk4QpLvJs}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__sms4L)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__eGlEl)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__tVtsR)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__hufA)}
        ...
        icon={
          ...
          >
            <Icon10Icon
              className={classNames(projectcss.all, sty.svg__twc8)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__cjTqj)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__brYrc)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__a6J9)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon11Icon
              className={classNames(projectcss.all, sty.svg__qMzYg)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__b9Bgm)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon5Icon
              className={classNames(projectcss.all, sty.svg__hVenQ)}
              role={"img"}
            />
          </GraphicIcon>
        }
