...
import sty from "./PlasmicHomeHero.module.css"; // plasmic-import: CTFlDz32c2/css
    ...
    >
      ...
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__f7VC5)}
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__hNrIt)}
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__yzLd4)}
            >
              <div
                className={classNames(projectcss.all, sty.freeBox__nLvV6, {
              ...
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox__c30XQ, {
              ...
              <div className={classNames(projectcss.all, sty.freeBox___1C2Y)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___13297, {
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__znWmw)}>
          <div className={classNames(projectcss.all, sty.freeBox__tmEn5)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <img
                  alt={""}
                  className={classNames(projectcss.img, sty.img___7VdQf)}
