...
import sty from "./PlasmicPageSiteBuilder.module.css"; // plasmic-import: PwVbfz5ruck/css
    ...
    >
      ...
      <ValuePropSection
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__weTN)}
            src={image6Zk4QpLvJs}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg___6ZDfZ)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__elq)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__k77HT)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__htyQb)}
        ...
        icon={
          ...
          >
            <Icon10Icon
              className={classNames(projectcss.all, sty.svg__tzOYk)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__pHlv)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__tB408)}
              role={"img"}
            />
          </GraphicIcon>
        }
