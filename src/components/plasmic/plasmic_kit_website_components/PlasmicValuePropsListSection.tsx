...
import sty from "./PlasmicValuePropsListSection.module.css"; // plasmic-import: 2xJBbfTP-H7/css
...
function PlasmicValuePropsListSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__sTac9)}>
        {p.renderPlasmicSlot({
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hIgK, {
      ...
      >
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___2Dl5S)}
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___0CTpv)}
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__e7JFe)}
                    >
                      <GraphicIcon
                        className={classNames(
                          "__wab_instance",
                      ...
                      >
                        <Icon17Icon
                          className={classNames(projectcss.all, sty.svg__hNpS8)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__is60X)}
                    >
                      <GraphicIcon
                        className={classNames(
                          "__wab_instance",
                      ...
                      >
                        <Icon17Icon
                          className={classNames(projectcss.all, sty.svg__x81Vx)}
                          role={"img"}
                        />
                      </GraphicIcon>
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <ButtonLink
                ...
                icon={
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__ix2FQ)}
                    role={"img"}
                  />
                }
        ...
        {false ? (
          <div className={classNames(projectcss.all, sty.freeBox__m8FK)}>
            <div className={classNames(projectcss.all, sty.freeBox__lsKij)}>
              <img
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__cQYiv, {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__nsS5V)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <img
                  alt={""}
                  className={classNames(projectcss.img, sty.img__s6UrP)}
