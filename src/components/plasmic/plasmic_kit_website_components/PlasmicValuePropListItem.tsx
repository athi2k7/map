...
import sty from "./PlasmicValuePropListItem.module.css"; // plasmic-import: lJppbKgSOw/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          ...
          >
            <Icon17Icon
              className={classNames(projectcss.all, sty.svg__nf3W)}
              role={"img"}
            />
          </GraphicIcon>
        ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vEe6Y)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__o5Hv)}>
          <div className={classNames(projectcss.all, sty.freeBox__rp92I)}>
            {p.renderPlasmicSlot({
