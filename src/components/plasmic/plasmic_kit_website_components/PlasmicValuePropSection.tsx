...
import sty from "./PlasmicValuePropSection.module.css"; // plasmic-import: 6Zq5_xjO9F/css
...
function PlasmicValuePropSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__qQnIe, {
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__gp7Wn)}
              src={image6Zk4QpLvJs}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            ...
            >
              <Icon6Icon
                className={classNames(projectcss.all, sty.svg__clLih)}
                role={"img"}
              />
            </GraphicIcon>
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___9IxVq, {
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__f8H6D, {
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__tgw42)}>
              {p.renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__quuat)}>
              {p.renderPlasmicSlot({
                defaultContents:
            ...
            <div className={classNames(projectcss.all, sty.freeBox__earlC)}>
              {p.renderPlasmicSlot({
                defaultContents:
            ...
            {(
              ...
              <p.Stack
                ...
                hasGap={true}
                className={classNames(projectcss.all, sty.extraSlot1, {
            ...
            {(
              ...
              <p.Stack
                ...
                hasGap={true}
                className={classNames(projectcss.all, sty.extraSlot2, {
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__sSdcT)}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <ButtonLink
                  ...
                  icon={
                    <IconIcon
                      className={classNames(projectcss.all, sty.svg___6Qi6S)}
                      role={"img"}
                    />
                  }
                  label={"Learn more"}
