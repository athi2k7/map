...
import sty from "./PlasmicDesignLandingPage.module.css"; // plasmic-import: 2sR5PRkxYAA/css
      ...
      >
        ...
        <ValuePropSection
          ...
          backgroundImage={
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__ikGoG)}
              src={image7RU1GD3ENw}
            />
          }
            ...
            <React.Fragment>
              <SmallValuePropCard
                ...
                icon={
                  ...
                  >
                    <Icon29Icon
                      className={classNames(projectcss.all, sty.svg__tEv8)}
                      role={"img"}
                    />
                  </GraphicIcon>
                }
              ...
              <SmallValuePropCard
                ...
                icon={
                  ...
                  >
                    <Icon36Icon
                      className={classNames(projectcss.all, sty.svg___4E4A9)}
                      role={"img"}
                    />
                  </GraphicIcon>
                }
              ...
              <SmallValuePropCard
                ...
                icon={
                  ...
                  >
                    <Icon23Icon
                      className={classNames(projectcss.all, sty.svg__cxgxo)}
                      role={"img"}
                    />
                  </GraphicIcon>
                }
                ...
                showcaseImage={
                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__kHnuo)}
                    loading={"lazy" as const}
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__rmrFy)}
          >
            <SmallValuePropCard
              ...
              description={
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__d527J)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              icon={
                ...
                >
                  <Icon15Icon
                    className={classNames(projectcss.all, sty.svg__vxGml)}
                    role={"img"}
                  />
                </GraphicIcon>
              }
              ...
              showcaseImage={
                <img
                  alt={""}
                  className={classNames(projectcss.img, sty.img___5Ogx0)}
                  loading={"lazy" as const}
            ...
            <SmallValuePropCard
              ...
              icon={
                ...
                >
                  <Icon28Icon
                    className={classNames(projectcss.all, sty.svg__pPgOx)}
                    role={"img"}
                  />
                </GraphicIcon>
              }
            ...
            <SmallValuePropCard
              ...
              icon={
                ...
                >
                  <Icon19Icon
                    className={classNames(projectcss.all, sty.svg__pMyv)}
                    role={"img"}
                  />
                </GraphicIcon>
              }
              ...
              rightImage={"rightImage" as const}
              showcaseImage={
                <div className={classNames(projectcss.all, sty.freeBox__ynomn)}>
                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__m0De8)}
                    loading={"lazy" as const}
        ...
        {false ? (
          <ValuePropSection
            ...
            actionButton={
              ...
              >
                <ButtonLink
                  ...
                  icon={
                    <IconIcon
                      className={classNames(projectcss.all, sty.svg__sTxQh)}
                      role={"img"}
                    />
                  }
                  label={"Learn more"}
            ...
            backgroundImage={
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__mQf1Q)}
                src={image6Zk4QpLvJs}
              />
            }
            ...
            extraSlot={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__ivd6B)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox___5DAKm)}
                >
                  <ValuePropListItem
                    slot={
                      <GraphicIcon
                  ...
                  <ValuePropListItem
                    slot={
                      ...
                      >
                        <Icon20Icon
                          className={classNames(projectcss.all, sty.svg__ocGkG)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
                  ...
                  <ValuePropListItem
                    slot={
                      ...
                      >
                        <Icon22Icon
                          className={classNames(projectcss.all, sty.svg__efUO)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
                  ...
                  <ValuePropListItem
                    slot={
                      ...
                      >
                        <Icon23Icon
                          className={classNames(projectcss.all, sty.svg__vb4Zs)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
        ...
        {false ? (
          <section className={classNames(projectcss.all, sty.section___7SPz1)}>
            <div className={classNames(projectcss.all, sty.freeBox__kTL)}>
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__ftbBm)}
        ...
        <section className={classNames(projectcss.all, sty.section__kjcNq)}>
          <p.Stack
            as={"div"}
          ...
          >
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__zJxSu)}
              src={imageJEb6FwUqh2}
            />

            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__tFkbk)}
              src={image3Ye53PEpLv}
            />
            ...
            {(hasVariant(variants, "nextjs", "nextjs") ? false : true) ? (
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__qbEiE, {
            ...
            {(hasVariant(variants, "gatsby", "gatsby") ? false : true) ? (
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__oHnca, {
            ...
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__xTg9J, {
            ...
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__xHliy)}
              src={image904Yo870MHj}
            />

            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__lpg5G)}
              src={image11C1Emdq7MU7}
            />

            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__rXX9)}
