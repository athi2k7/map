...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: E_l1hqcHcA/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mSr9Y)}
      >
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__h7NCt)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__cXRqA)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__u5YiU)}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__u6Jz3)}>
            <div
              className={classNames(projectcss.all, sty.freeBox__sIeN, {
            ...
            <div className={classNames(projectcss.all, sty.freeBox___7Mprr)}>
              {p.renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__nkMqq)}>
              {p.renderPlasmicSlot({
