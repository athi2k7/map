...
import sty from "./PlasmicLimitlessExpressivitySectionForSites.module.css"; // plasmic-import: 8suVFciYp4t/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ovmf)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__rTydU)}
        >
          <SmallValuePropCard
            ...
            icon={
              ...
              >
                <Icon28Icon
                  className={classNames(projectcss.all, sty.svg__qmZ5G)}
                  role={"img"}
                />
              </GraphicIcon>
            }
            ...
            showcaseImage={
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__yqYnj)}
          ...
          <SmallValuePropCard
            ...
            icon={
              ...
              >
                <Icon14Icon
                  className={classNames(projectcss.all, sty.svg__dRqu4)}
                  role={"img"}
                />
              </GraphicIcon>
            }
            ...
            showcaseImage={
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__l7ZhC)}
                loading={"lazy" as const}
        ...
        <SmallValuePropCard
          ...
          icon={
            ...
            >
              <Icon15Icon
                className={classNames(projectcss.all, sty.svg___9O0OX)}
                role={"img"}
              />
            </GraphicIcon>
          }
          ...
          showcaseImage={
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__d3XCr)}
              loading={"lazy" as const}
