...
import sty from "./PlasmicValuePropSummary.module.css"; // plasmic-import: 2LcO8okO6S/css
    ...
    >
      <ValuePropCard
        ...
        img={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__eolxh)}
      ...
      <ValuePropCard
        ...
        img={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__mxzx8)}
            src={image385XxeDTi2}
          />
        }
        num={"2"}
      ...
      <ValuePropCard
        ...
        img={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__qyWyu)}
      ...
      >
        <div className={classNames(projectcss.all, sty.column__mU2T)}>
          <FirstStepLink
        ...
        <div className={classNames(projectcss.all, sty.column__ywcKg)}>
          <FirstStepLink
        ...
        <div className={classNames(projectcss.all, sty.column__vyV8M)}>
          <FirstStepLink
