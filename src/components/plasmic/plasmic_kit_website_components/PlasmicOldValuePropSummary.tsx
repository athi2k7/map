...
import sty from "./PlasmicOldValuePropSummary.module.css"; // plasmic-import: rBgbWjsA0sd/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___6FT6B)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__aoice)}
        >
          <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__kfCj6)}>
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img___3Lai)}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lY3Ju)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__oAzHa)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wtJo)}>
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__t9WJu)}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vPm9)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__moeu)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__vuRpx)}>
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img___3JmUr)}
