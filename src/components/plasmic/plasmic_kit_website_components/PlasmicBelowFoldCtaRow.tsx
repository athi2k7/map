...
import sty from "./PlasmicBelowFoldCtaRow.module.css"; // plasmic-import: JF4MWU3g67-/css
  ...
  return (
    ...
    >
      <ButtonLink
        ...
        icon={
          <IconIcon
            className={classNames(projectcss.all, sty.svg__fp7Xm)}
            role={"img"}
          />
        }
        label={
      ...
      {(hasVariant(variants, "hideLevels", "hideLevels") ? false : true) ? (
        <ButtonLink
          ...
          icon={
            <IconIcon
              className={classNames(projectcss.all, sty.svg__zuYzv)}
              role={"img"}
            />
          }
          label={
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___0MOFa)}
            >
              <img
              ...
              <div className={classNames(projectcss.all, sty.freeBox__mDfeL)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
