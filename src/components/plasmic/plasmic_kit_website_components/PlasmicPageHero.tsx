...
import sty from "./PlasmicPageHero.module.css"; // plasmic-import: MaAtk98o9f/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dso5W)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <GraphicIcon
            ...
            >
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__yfuCz)}
                role={"img"}
              />
            </GraphicIcon>
          ),
        ...
        <div className={classNames(projectcss.all, sty.freeBox__rb3Jg)}>
          {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__gEcB)}>
          {p.renderPlasmicSlot({
