...
import sty from "./PlasmicPricingFeatureTable.module.css"; // plasmic-import: 0JMC2aEx9m/css
...
function PlasmicPricingFeatureTable__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zzEbZ)}>
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wJd2P)} />
