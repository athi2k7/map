...
import sty from "./PlasmicValuePropContainer.module.css"; // plasmic-import: jJwXbiB2Ic/css
    ...
    >
      ...
      >
        <p.PlasmicIcon
          ...
          className={classNames(projectcss.all, sty.svg__tXdwi, {
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wl33N)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hlNmg)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__c3Ngm)}>
            {p.renderPlasmicSlot({
          ...
          <div className={classNames(projectcss.all, sty.freeBox__pZkQq)}>
            {p.renderPlasmicSlot({
          ...
          <div className={classNames(projectcss.all, sty.freeBox__veZia)}>
            {p.renderPlasmicSlot({
              defaultContents:
        ...
        <ButtonLink
          ...
          icon={
            <IconIcon
              className={classNames(projectcss.all, sty.svg__v37Z3)}
              role={"img"}
            />
          }
          label={"Learn more"}
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__kIdlr, {
