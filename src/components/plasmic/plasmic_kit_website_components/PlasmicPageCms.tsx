...
import sty from "./PlasmicPageCms.module.css"; // plasmic-import: KCzdJBxTJE/css
    ...
    >
      ...
      <PageHero
        ...
        slot2={
          ...
          >
            <Icon12Icon
              className={classNames(projectcss.all, sty.svg__hEbgH)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__bdnoh)}
            src={image6Zk4QpLvJs}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__hBnRs)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__hm1T)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__sr1Qg)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__wuUG)}
        ...
        icon={
          ...
          >
            <Icon10Icon
              className={classNames(projectcss.all, sty.svg__a9AYf)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__pFcS)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon6Icon
              className={classNames(projectcss.all, sty.svg__pyDn7)}
              role={"img"}
            />
          </GraphicIcon>
        }
      ...
      <ValuePropSection
        ...
        backgroundImage={
          <img
            alt={""}
            className={classNames(projectcss.img, sty.img__jqeJ2)}
            src={image7RU1GD3ENw}
          />
        }
        ...
        icon={
          ...
          >
            <Icon5Icon
              className={classNames(projectcss.all, sty.svg__ux9Lx)}
              role={"img"}
            />
          </GraphicIcon>
        }
