...
import sty from "./PlasmicPriceTier.module.css"; // plasmic-import: AapVVGU4iu/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fhEe6)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__kftjm)}>
          {p.renderPlasmicSlot({
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.ctaLink)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Linky
