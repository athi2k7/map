...
import sty from "./PlasmicSmallValuePropCard.module.css"; // plasmic-import: ZsmzGgkZw2/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vGm3C, {
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            ...
            >
              <Icon6Icon
                className={classNames(projectcss.all, sty.svg___1Lv7H)}
                role={"img"}
              />
            </GraphicIcon>
          ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__rfSRg, {
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__roI0C, {
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___2LjYw, {
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__c1XJd)}>
                <div className={classNames(projectcss.all, sty.freeBox__ev4I)}>
                  {p.renderPlasmicSlot({
              ...
              <div
                className={classNames(projectcss.all, sty.freeBox__cTaeG, {
      ...
      {(hasVariant(variants, "ltr", "ltr") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___01WCm, {
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img___8HVn7)}
                src={image16EjT54Ab5}
              />
            ),
          ...
          {(
            ...
            <div
              ...
              className={classNames(projectcss.all, sty.videoHover, {
