...
import { useScreenVariants as useScreenVariantsk7XdGnvUtPzS } from "./PlasmicGlobalVariant__Screen"; // plasmic-import: k7xdGnvUtPZ_s/globalVariant
...
import sty from "./PlasmicCommonLandingPage2.module.css"; // plasmic-import: vfJVtA9eRVA/css
...
function PlasmicCommonLandingPage2__RenderFunc(props: {
  ...
  const globalVariants = ensureGlobalVariants({
    theme: useTheme(),
    screen: useScreenVariantsk7XdGnvUtPzS()
  });
      ...
      >
        <HomeHero
          ...
          slot2={p.renderPlasmicSlot({
            defaultContents: (
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__g76O)}
        ...
        <ValuePropsListSection
          ...
          showcaseImage={
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__vdyNb)}
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__pHnPz)}
              >
                <ValuePropListItem
                  slot={
                    <GraphicIcon
                    ...
                    >
                      <Icon12Icon
                        className={classNames(projectcss.all, sty.svg___4NgSb)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
                ...
                <ValuePropListItem
                  slot={
                    ...
                    >
                      <Icon20Icon
                        className={classNames(projectcss.all, sty.svg__yoPqM)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
                ...
                <ValuePropListItem
                  slot={
                    ...
                    >
                      <Icon22Icon
                        className={classNames(projectcss.all, sty.svg__sbO0V)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
                ...
                <ValuePropListItem
                  slot={
                    ...
                    >
                      <Icon27Icon
                        className={classNames(projectcss.all, sty.svg__aqfA)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
        ...
        <ValuePropSection
          ...
          backgroundImage={
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__uxPm1)}
              src={image7RU1GD3ENw}
            />
          }
          ...
          extraSlot={
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__vfOyv)}
            >
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__qBImS)}
              >
                <SmallValuePropCard
                  actionButton={null}
                  className={classNames(
                  ...
                  icon={
                    ...
                    >
                      <Icon32Icon
                        className={classNames(projectcss.all, sty.svg__mbVe5)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
                ...
                <SmallValuePropCard
                  ...
                  icon={
                    ...
                    >
                      <Icon27Icon
                        className={classNames(projectcss.all, sty.svg__u6Koz)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
                ...
                <SmallValuePropCard
                  ...
                  icon={
                    ...
                    >
                      <Icon6Icon
                        className={classNames(projectcss.all, sty.svg___1Zc7D)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
                ...
                <SmallValuePropCard
                  ...
                  icon={
                    ...
                    >
                      <Icon24Icon
                        className={classNames(projectcss.all, sty.svg__jFUiX)}
                        role={"img"}
                      />
                    </GraphicIcon>
                  }
        ...
        {false ? (
          <ValuePropSection
            ...
            actionButton={
              ...
              >
                <ButtonLink
                  ...
                  icon={
                    <IconIcon
                      className={classNames(projectcss.all, sty.svg__lw3GF)}
                      role={"img"}
                    />
                  }
                  label={"Learn more"}
            ...
            backgroundImage={
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__d0QKq)}
                src={image6Zk4QpLvJs}
              />
            }
            ...
            extraSlot={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__uuGxi)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__np2Uo)}
                >
                  <ValuePropListItem
                    slot={
                      <GraphicIcon
                      ...
                      >
                        <Icon21Icon
                          className={classNames(projectcss.all, sty.svg__am5X0)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
                  ...
                  <ValuePropListItem
                    slot={
                      ...
                      >
                        <Icon20Icon
                          className={classNames(projectcss.all, sty.svg__zKaXj)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
                  ...
                  <ValuePropListItem
                    slot={
                      ...
                      >
                        <Icon22Icon
                          className={classNames(projectcss.all, sty.svg__fRu4D)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
                  ...
                  <ValuePropListItem
                    slot={
                      ...
                      >
                        <Icon23Icon
                          className={classNames(projectcss.all, sty.svg__u050)}
                          role={"img"}
                        />
                      </GraphicIcon>
                    }
        ...
        {false ? (
          <section className={classNames(projectcss.all, sty.section__n0FHy)}>
            <div className={classNames(projectcss.all, sty.freeBox__scPjK)}>
              <img
                alt={""}
                className={classNames(projectcss.img, sty.img__lsQrq)}
        ...
        <section className={classNames(projectcss.all, sty.section__hl4K)}>
          <p.Stack
            as={"div"}
            ...
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__hNze)}
                    src={imageJEb6FwUqh2}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__skRo2)}
                    src={image3Ye53PEpLv}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__irid5)}
                    src={image4SuzPkCmZfz}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__f1Bts)}
                    src={image8Pjopgnvz6}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__vvY5U)}
                    src={image53LFnfKPfDu}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__oqmll)}
                    src={image904Yo870MHj}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__xO4AM)}
                    src={image11C1Emdq7MU7}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__mn6Pi)}
                    src={image12WiXt2Gdxg}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__orpQs)}
                    src={image75WTvOxGb6B}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img___5L6GX)}
                    src={image748T6TyW2Sn}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__xj1K6)}
                    src={image76K6RrS2DFz}
                  />

                  <img
                    alt={""}
                    className={classNames(projectcss.img, sty.img__iigpS)}
                    src={image77XlZeK5Zq}
                  />
                </React.Fragment>
              ),
        ...
        {false ? (
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___1BzKw)}
            >
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__dmM1K)}
              >
                <div className={classNames(projectcss.all, sty.column__b3CIq)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__rZkbL)}
                ...
                <div className={classNames(projectcss.all, sty.column__cPnk8)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__rK2I2)}
                        loading={"lazy" as const}
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__y6VVa)}
              >
                <div className={classNames(projectcss.all, sty.column__dykeY)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img___8POp)}
                        src={image83G6DF9FdL}
                      />
                    }
                  >
                ...
                <div className={classNames(projectcss.all, sty.column___7Obv)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__uakJa)}
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__lmCrN)}
              >
                <div className={classNames(projectcss.all, sty.column__tMvys)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__u9Zkf)}
                        loading={"lazy" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__rf1Bi)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__v3Dk0)}
                        loading={"lazy" as const}
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__dVsFh)}
              >
                <div className={classNames(projectcss.all, sty.column__c2K8)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__xcmX7)}
                        loading={"lazy" as const}
                        src={image82LYItEpXgS}
                      />
                    }
                  ...
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img___661B)}
                        loading={"lazy" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__w1QEk)}>
                  <SmallValuePropCard
                    ...
                    showcaseImage={
                      <img
                        alt={""}
                        className={classNames(projectcss.img, sty.img__bszud)}
                        loading={"lazy" as const}
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__ibOkh)}
              />
            </p.Stack>
          </ValuePropCardsSection>
        ) : null}
            ...
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__caSsq)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__tSN2)}
                  >
                    <SmallValuePropCard
                      actionButton={null}
                      description={null}
                    ...
                    <SmallValuePropCard
                      ...
                      showcaseImage={
                        <img
                          alt={""}
                          className={classNames(projectcss.img, sty.img___2Yqv)}
                          loading={"lazy" as const}
                          src={image819KjKXf8AA}
                        />
                      }
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__mivs4)}
                  >
                    <SmallValuePropCard
                      actionButton={null}
                      className={classNames(
                      ...
                      showcaseImage={
                        <img
                          alt={""}
                          className={classNames(projectcss.img, sty.img__puKh7)}
                          src={image83G6DF9FdL}
                        />
                      }
                    >
                    ...
                    <SmallValuePropCard
                      ...
                      showcaseImage={
                        <img
                          alt={""}
                          className={classNames(projectcss.img, sty.img__tp883)}
                          src={image78QZwEvhzU2}
                        />
                      }
                    >
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___9Jeii)}
                  >
                    <SmallValuePropCard
                      actionButton={null}
                      className={classNames(
                      ...
                      showcaseImage={
                        <img
                          alt={""}
                          className={classNames(projectcss.img, sty.img__rc1ST)}
                          loading={"lazy" as const}
                          src={image82LYItEpXgS}
                        />
                      }
                    ...
                    <SmallValuePropCard
                      ...
                      showcaseImage={
                        <img
                          alt={""}
                          className={classNames(projectcss.img, sty.img__kwVgy)}
                          loading={"lazy" as const}
                          src={image84FyKjl3Owe}
                        />
                      }
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__wMu7V)}
                  >
                    <SmallValuePropCard
                      actionButton={null}
                      className={classNames(
                      ...
                      showcaseImage={
                        <img
                          alt={""}
                          className={classNames(projectcss.img, sty.img__pX7Sx)}
                          loading={"lazy" as const}
                          src={image86ZvTNx6QJy}
                        />
                      }
        ...
        <a
          ...
          className={classNames(projectcss.a, sty.productHuntBadge)}
          href={
        ...
        >
          <img
            ...
            className={classNames(projectcss.img, sty.img__gdRjs)}
            loading={"lazy" as const}
            src={
