...
import sty from "./PlasmicValuePropCard.module.css"; // plasmic-import: qSazSuRq3D/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rQgFt)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__b4ZQy)}>
          {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__i2R93)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(projectcss.img, sty.img__efqk)}
