...
import sty from "./PlasmicColumns.module.css"; // plasmic-import: Dhl7VIo-gaZ2/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          ...
          >
            <CompLak26M0UL2W
              className={classNames("__wab_instance", sty.youTube__wCcE)}
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <ListItem
            ...
            className={classNames("__wab_instance", sty.listItem__ij6Ei)}
            title={"Google Maps"}
          >
            <CompWvOfmajzEzT
              center={{ lat: -5, lng: -40 }}
