...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: 4XzjSdicHEy/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ivk7K, {
          [sty.freeBox__noBody__ivk7K28T2X]: hasVariant(
            variants,
            "noBody",
            "noBody"
          )
      ...
      {(hasVariant(variants, "noBody", "noBody") ? false : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__wMt6C, {
            [sty.freeBox__noBody__wMt6C28T2X]: hasVariant(
              variants,
              "noBody",
              "noBody"
            )
